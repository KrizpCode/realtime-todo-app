            ...
            <section className='form-container'>
                ...
                <form className='form' onSubmit={updateAccount}>
                    ...
                    <input
                        ...
                        required 
                    />
                    <input className='form__input' placeholder="New Password" type="password" ref={passwordRef} name="password" id="password" required />
                    ...
                    <Link className="text-align-right text--small" to='/'>Cancel</Link>
                    <input className='form__submit-button' type="submit" value="Update Profile" disabled={loading} />
                </form>
            </section>
        </>
    )
